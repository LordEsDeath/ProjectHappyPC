...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    @if( Gate::allows('isAdmin') || Gate::allows('isManager') )
      <li class="treeview">
        ...
        <ul class="treeview-menu">
			...
			<li><a href="{{ url('/productlist') }}"><i class="fa fa-circle-o"></i> NewsList</a></li>
      <li><a href="{{ url('/gamelist') }}"><i class="fa fa-circle-o"></i> GameList</a></li>
      <li><a href="{{ url('/categorygamelist') }}"><i class="fa fa-circle-o"></i> GameCategoryList</a></li>
    ...
    <li><a href="{{ url('/commentslist') }}"><i class="fa fa-comments"></i> <span>Comments</span></a></li>
    @endif
    </ul>
  </section>
